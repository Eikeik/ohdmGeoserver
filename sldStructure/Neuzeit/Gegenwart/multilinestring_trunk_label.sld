...
<StyledLayerDescriptor version="1.0.0" 
 ...
 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<NamedLayer>
    	<Name>multilinestring_trunk_label</Name>
    	<UserStyle>
      		<Title>Orange rectangle with white letters</Title>
      		<Abstract>
              Draws a orange rectangle with white letters in 3 different scales that change the distance between two labels.
          	</Abstract>
      		<FeatureTypeStyle>
        		<Rule>
